            ...
            <div class="card-body position-relative mb-0 pb-0" style="background-color: #F9F9F9;">
                <div class="row pb-5">
                    <div class="form-group raw mt-2 " style="display: flex; flex-wrap: wrap;  ">
                        <label class="col-form-label  ml-3 mr-4 ">اسم المبلغ : </label>
                        <label class="col-form-label  ml-2 mr-4  ">احلام محمد عبده الفاشق  </label>
                        <label class="col-form-label  ml-5 mr-4  ">رقم الهاتف : </label>
                        <label class="col-form-label  ml-2 mr-4  ">773773773  </label>
                    </div>
                    <div class=" mt-4  border-bottom " style=" ">
                        <label class="ml-3 mr-4 ">نوع البلاغ : </label>
                        <label class="ml-2 mr-4 ">مسحوب  </label>
                        <label class="ml-5 mr-4 ">اسم الصيديلة : </label>
                        <label class="ml-2 mr-4 ">ابن حيان  </label>
                        <label class="ml-5 mr-4 ">اسم الدواء : </label>
                        <label class="ml-2 mr-4 mb-3  ">Panadol  </label>
                    </div>
                    <div class=" mt-4" >
                        <a class="text-center "  href="#"><i class="fas fa-caret-down "></i></a>
                    </div>
                </div>
            </div>
        </div>
